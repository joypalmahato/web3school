        ...
        >
          {displayRoles.map((role) => (
            <Link
              ...
              className="min-w-[260px] sm:min-w-[280px] flex-shrink-0 scroll-snap-align-start bg-[#111111]/60 backdrop-blur-md border border-white/[0.08] rounded-xl p-5 md:p-7 hover:border-white/[0.16] transition-colors duration-200 block"
            >
